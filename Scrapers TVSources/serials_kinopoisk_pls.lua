-- скрапер TVS для загрузки плейлиста киноаоиска "Сериалы" (29/1/21)
-- Copyright © 2017-2021 Nexterr | https://github.com/Nexterr-origin/simpleTV-Scripts
-- ## необходим ##
-- видоскрипт: kinopoisk.lua
-- ##
	module('serials_kinopoisk_pls', package.seeall)
	...
	local function LoadFromSite()
		...
		showMess('«Сериалы» загрузка ...', ARGB(255, 153, 255, 153), 600000)
		local t, i = {}, 1
			...
			for c = 1, 600 do
				local url = string.format(decode64('aHR0cHM6Ly9iYXpvbi5jYy9hcGkvanNvbi8/dG9rZW49Mjg0OGY3OWNhMDlkNGJiYmY0MTliY2RiNDY0YjRkMTEmdHlwZT1zZXJpYWwmcGFnZT0lcw'), c)
