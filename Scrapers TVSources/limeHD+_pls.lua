-- скрапер TVS для загрузки плейлиста "LimeHD+" https://limehd.tv (8/12/23)
...
local filter = {
	...
	function GetList(UpdateID, m3u_file)
		...
		local outm3u, err = tvs_func.get_m3u(decode64('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL05leHRlcnItb3JpZ2luL3NpbXBsZVRWLVBsYXlsaXN0cy9tYWluL2xpbWVoZCUyQg'))
		if err ~= '' then
