-- скрапер TVS для загрузки плейлиста кинопоиска "Фильмы A" (29/6/23)
-- Copyright © 2017-2023 Nexterr | https://github.com/Nexterr-origin/simpleTV-Scripts
-- ## необходим ##
-- видоскрипт: kinopoisk.lua
	module('kinopoisk_films-a_pls', package.seeall)
	local my_src_name = 'Фильмы A'
	...
	local function LoadFromSite()
		...
		local t = {}
			for c = 1, 1500 do
				local url = string.format(decode64('aHR0cHM6Ly9hcGkuYXBidWdhbGwub3JnLz90b2tlbj0wNDk0MWE5YTNjYTNhYzE2ZTJiNDMyNzM0N2JiYzEmb3JkZXI9ZGF0ZSZsaXN0PW1vdmllJnBhZ2U9JXM'), c)
