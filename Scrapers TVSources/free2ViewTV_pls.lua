-- скрапер TVS для загрузки плейлиста "Free2ViewTV" https://github.com/geonsey/Free2ViewTV (12/4/21)
	...
	function GetList(UpdateID, m3u_file)
		...
		local t_pls = tvs_core.GetPlsAsTable(outm3u)
			for i = 1, #t_pls do
				...
				t_pls[i].group = t_pls[i].group:gsub('NEW %| ', '')
				t_pls[i].group = t_pls[i].group:gsub('** NEW CHANNELS.-$', 'UNDEFINED')
