-- скрапер TVS для загрузки плейлиста киноаоиска "Сериалы 2" (29/1/21)
...
-- ##
	...
	local function LoadFromSite()
		...
		local t, i = {}, 1
			...
			for c = 1, 600 do
				local url = string.format(decode64('aHR0cHM6Ly92aWRlb2Nkbi50di9hcGkvdHYtc2VyaWVzP2FwaV90b2tlbj1vUzdXenZOZnhlNEs4T2NzUGpwQUlVNlh1MDFTaTBmbSZsaW1pdD0xMDAmcGFnZT0lcw'), c)
