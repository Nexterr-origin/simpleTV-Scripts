-- скрапер TVS для загрузки плейлиста "seversk.ru" https://seversk.ru/ (7/9/24)
-- Copyright © 2017-2024 Nexterr, NEKTO666 | https://github.com/Nexterr-origin/simpleTV-Scripts
-- ## переименовать каналы ##
local filter = {
	{'Мир-ТВ', 'МИР'},
	}
	module('seversk_pls', package.seeall)
	local my_src_name = 'Северск'
	...
	function GetList(UpdateID, m3u_file)
		...
		local outm3u, err = tvs_func.get_m3u(decode64('aHR0cDovL2hscy5zZXZlcnNrLnJ1OjgwODAvcGxheWxpc3QubTN1OA'))
		if err ~= '' then
